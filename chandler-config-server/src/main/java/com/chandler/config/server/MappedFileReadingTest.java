 ...
 * 类功能描述
 *
 * @author 钱丁君-chandler 2021/12/16 3:49 下午
 * @since 1.8
 */
public class MappedFileReadingTest {
    ...
    public void testReadConsumeQueue() throws IOException {
        filePath = "/Users/chandler/store/consumequeue/TopicTest/0/00000000000000000000";
        init(0, 1000 * 1000 * 6);
        do {
    ...
    public void testReadIndexFile() throws IOException {
        filePath = "/Users/chandler/store/index/20211216143238938";
    ...
    public void testReadCommitLog() throws IOException {
        filePath = "/Users/chandler/store/commitlog/00000000000000000000";
